//
//  TriangleMetalRendererBackup.swift
...
final class TriangleMetalRendererBackup: NSObject, MTKViewDelegate {
    ...
    private func buildResources(mtkView: MTKView) {
        ...
        let vertexFunction = library.makeFunction(name: "vs_backup_triangle_gradient")
        let fragmentFunction = library.makeFunction(name: "fs_backup_triangle_gradient")
