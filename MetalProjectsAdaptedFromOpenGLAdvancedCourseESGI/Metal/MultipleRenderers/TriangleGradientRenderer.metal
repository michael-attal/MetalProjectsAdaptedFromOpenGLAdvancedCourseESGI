//
//  TriangleGradientRenderer.metal
...
struct TriangleGradientVertexOut {
    float4 position [[position]];
    float2 uv; // Fragment coordinates
};

vertex TriangleGradientVertexOut vs_triangle_gradient(uint vertexID [[vertex_id]])
{
    TriangleGradientVertexOut out;
...
fragment float4 fs_triangle_gradient(TriangleGradientVertexOut in [[stage_in]])
{
